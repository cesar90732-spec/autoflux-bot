...
// Navegação lateral do painel. Os itens além do Dashboard apontam para
// rotas que serão implementadas nas próximas etapas (WhatsApp, contatos,
// conversas, etc.) — já deixamos a navegação pronta para não precisar
// reestruturar o layout depois.
